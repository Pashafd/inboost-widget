    ...
    use: [
        ...
        },
        {
            ...
            options: {
                ...
                modules: {
                    auto: true,
                    localIdentName: envCmp("[local]-[contenthash:5]", "[contenthash:5]"),
...
const imagesRule = () => ({
    ...
    type: "asset/resource",
    generator: {
        filename: envCmp("assets/[name]-[contenthash:5][ext]", "assets/[contenthash:5][ext]"),
    },
});
...
const cssExtractPlugin = new MiniCssExtractPlugin({
    filename: envCmp("[name]-[contenthash:5].css", "[contenthash:5].css"),
    chunkFilename: envCmp("[name]-[contenthash:5].css", "[contenthash:5].css"),
});
...
module.exports = {
    ...
    output: {
        ...
        filename: envCmp("[name]-[contenthash:5].js", "[contenthash:5].js"),
    },
    optimization: {
        splitChunks: {
            cacheGroups: {
    ...
    plugins: [htmlPlugin, cleanPlugin, cssExtractPlugin, environmentPlugin],
};
